...
if __name__ == "__main__":
    ...
    filenames = ['models/lstm_256h_1l_50b_Adam_1e-3',
                 'models/lstm_256h_1l_50b_Adam_1e-4',
                 'models/lstm_256h_1l_50b_SGD_1e-3',
    ...
    figval.savefig('plots/lstmbig_val.pdf', bbox_inches='tight')
    ...
    figtest.savefig('plots/lstmbig_test.pdf', bbox_inches='tight')
