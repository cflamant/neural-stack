...
if __name__ == "__main__":
    ...
    filenames = ['models/manystack_64h_64e_1l_50b_Adam_1e-3_1',
                 'models/manystack_64h_64e_1l_50b_Adam_1e-3_2',
                 'models/manystack_64h_64e_1l_50b_Adam_1e-3_3',
                 'models/manystack_64h_64e_1l_50b_Adam_1e-3_5',
                 'models/stack_64h_64e_1l_50b_Adam_1e-3_accfreq1000',
                 'models/stack_64h_64e_1l_50b_Adam_1e-3_accfreq1000_2'
                ]
    ...
    figloss.savefig('plots/manystack_loss.pdf', bbox_inches='tight')
    ...
    figval.savefig('plots/manystack_val.pdf', bbox_inches='tight')
    ...
    figtest.savefig('plots/manystack_test.pdf', bbox_inches='tight')
