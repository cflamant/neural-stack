...
if __name__ == "__main__":
    ...
    filenames = ['neural-stack/models/lstm_256h_2l_50b_Adam_1e-4',
                 'neural-stack/models/lstm_512h_1l_50b_Adam_1e-4',
                 'neural-stack/models/longlstm_128h_4l_50b_Adam_1e-3'
                ]
    ...
    figval.savefig('neural-stack/plots/lstmsizes_val.pdf', bbox_inches='tight')
    ...
    figtest.savefig('neural-stack/plots/lstmsizes_test.pdf', bbox_inches='tight')
