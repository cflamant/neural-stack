...
if __name__ == "__main__":
    ...
    filenames = ['neural-stack/models/stack_64h_64e_1l_50b_Adam_1e-3',
                 'neural-stack/models/stack_64h_64e_1l_50b_SGD_1e-3',
                 'neural-stack/models/stack_64h_64e_1l_50b_SGD_1e-4'
                ]
    ...
    figval.savefig('neural-stack/plots/stacksgd_val.pdf', bbox_inches='tight')
    ...
    figtest.savefig('neural-stack/plots/stacksgd_test.pdf', bbox_inches='tight')
