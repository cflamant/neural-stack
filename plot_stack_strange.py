...
if __name__ == "__main__":
    ...
    filenames = ['models/stack_16h_16e_1l_50b_Adam_1e-3_accfreq1000',
                 'models/stack_64h_1e_1l_50b_Adam_1e-3',
    ...
    figloss.savefig('plots/strangestack_loss.pdf', bbox_inches='tight')
    ...
    figval.savefig('plots/strangestack_val.pdf', bbox_inches='tight')
    ...
    figtest.savefig('plots/strangestack_test.pdf', bbox_inches='tight')
