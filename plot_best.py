...
if __name__ == "__main__":
    ...
    filenames = ['models/longrnn_256h_4l_50b_Adam_1e-4',
                 'models/vlonglstm_256h_2l_50b_Adam_1e-3',
    ...
    figloss.savefig('plots/best_loss.pdf', bbox_inches='tight')
    ...
    figval.savefig('plots/best_val.pdf', bbox_inches='tight')
    ...
    figtest.savefig('plots/best_test.pdf', bbox_inches='tight')
